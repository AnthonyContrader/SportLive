...
To optimize the microservizio2 application for production, run:
...
[Service Discovery and Configuration with Consul]: https://www.jhipster.tech/documentation-archive/v5.2.1/microservices-architecture/#consul
