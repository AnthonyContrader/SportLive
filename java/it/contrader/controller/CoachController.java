...
public class CoachController {
	...
	@RequestMapping(value = "/pleyerInser", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/playerInsert", method = RequestMethod.POST)
	public String insertPlayer(HttpServletRequest request) {
		int idPlayer = 2;
		String nickname = request.getParameter("username").toString();
		String password = request.getParameter("password").toString();
		String playertype = request.getParameter("ruolo").toString();
		Integer Score = Integer.parseInt(request.getParameter("score"));

		PlayerDTO playerObj = new PlayerDTO(0, idPlayer, nickname, password, playertype, Score);
